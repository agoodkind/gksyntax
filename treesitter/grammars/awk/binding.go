// Package awk exposes the tree-sitter AWK grammar to the splitter. The
...
// their macros from colliding. AWK has no maintained Go-module binding against
...
// Language returns the tree-sitter Language pointer for AWK.
